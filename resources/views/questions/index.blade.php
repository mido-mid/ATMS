                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="{{route('questions.create')}}">{{ __('add new question') }}</a></li>
                        </ol>
                    </div>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <form action="{{ route('questions.status', $question->id) }}" method="post">
                                                    ...
                                                    <button type="button" class="btn btn-block btn-{{ $question->status == 'active' ? 'success': 'danger'}}" onclick="confirm('{{ __("Are you sure you want to change question status ?") }}') ? this.parentElement.submit() : ''">{{ $question->status }}</button>
