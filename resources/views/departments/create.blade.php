                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="{{route('departments.index')}}">{{ __('admin.vendors') }}</a></li>
                        </ol>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card card-primary">
                            ...
                            <!-- /.card-header -->
                            <!-- form start -->
                            <form role="form" action="@if(isset($department)){{route('vendors.update',$vendor->id) }} @else {{route('vendors.store') }} @endif" method="POST" enctype="multipart/form-data">
                                @csrf
